 <footer class="w3l-footer-22 position-relative mt-5 pt-5">
                ...
                <div class="text-txt">
                    <div class="right-side">
                        ...
                        <div class="row align-items-center w3l-forms-9">
                            <div class="main-midd col-md-6">
                                <h4 class="title-head mb-lg-2">Contact Us to join our Mission</h4>
                                <p>Newsletter</p>
                            </div>
                    ...
                    <div class="row sub-columns">
                        <div class="col-lg-2 col-sm-6 sub-two-right">
                            <h6>Quick links</h6>
                            <ul>
                                <li><a href="index.php"><span class="fa fa-angle-double-right mr-2"></span>Home</a>
                                </li>
                                <li><a href="about.php"><span class="fa fa-angle-double-right mr-2"></span>About</a>
                                </li>
                                <li><a href="courses.php"><span
                        ...
                        <div class="col-lg-3 col-sm-6 sub-one-left mt-lg-0 mt-sm-5 mt-4">
                            ...
                            <div class="column2">
                                <div class="href1"><span class="fa fa-envelope-o" aria-hidden="true"></span><a
                                        href="mailto:info@example.com">info@pidit3.com</a>
                                </div>
                                <div class="href2"><span class="fa fa-phone" aria-hidden="true"></span><a
                                        href="tel:+91 90747 14065">+91 90747 14065</a>
                                </div>
                                <div>
                                    <p class="contact-para"><span class="fa fa-map-marker"
                                            aria-hidden="true"></span>Gwalior , M.P (India)</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 sub-one-left ab-right-cont pl-lg-5 mt-lg-0 mt-sm-5 mt-4">
                            <h6>About </h6>
                            <p>We work with a vision to bring a positive transformation into the life of people by helping them to explore their true potential so that they can utilize their brain capacity to achieve their dreams in life and lead a happy life fille with self-satisfaction.</p>
                            <div class="columns-2">
                                <ul class="social">
        ...
        <div class="copyright-footer text-center">
            <div class="container">
                <div class="columns">
                    <p>@2022 PIDIT3. All rights reserved. Design by <a href="http://eibo.in/"
                            target="_blank"></a>
                        EIBO SERVICES PVT. LTD.</a>
                    </p>
                </div>
            </div>
        </div>
