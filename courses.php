            ...
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="PIDIT LOGO-05.png" alt="" class="w-50" style="margin-top:-15px;"></a>
                </h1>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="courses.html">Download</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="w3l-breadcrumb">
            <div class="container">
                ...
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span>Downloads
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="w3l-grids-block-5 w3l-grids-block-6 py-5">
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mx-auto mb-5 pb-sm-4">
                <h3 class="title-main"><span>Downloads</span></h3>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-single">
                        <div class="grids5-info position-relative">
                            <img src="assets/images/img1.jpeg" alt="" class="img-fluid" style="height:230px;"/>
                            <!--<div class="meta-list">-->
                        ...
                        <div class="content-main-top">
                            <h4><a href="#blog">What is PIDIT ?</a></h4>
                            <div class="content-top mb-4 mt-3">
                                <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                    <li> <a href="assets/pdf/pidit.pdf" target="_blank" style="color:blue;">Download</a> </li>
                                    </
                                </ul>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card-single">
                        <div class="grids5-info position-relative">
                            <img src="assets/images/brocher.jpeg" alt="" class="img-fluid" style="height:230px;"/>
                            
                        </div>
                        <div class="content-main-top">
                            <h4><a href="#blog">Know your inborn talent </a></h4>
                            <div class="content-top mb-4 mt-3">
                                <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                    <li> <a href="assets/pdf/brocher.pdf" target="_blank" style="color:blue;">Download</a> </li>
                                    </
                                </ul>
                            </div>
